...
.PHONY: test-service-creation-e2e
test-service-creation-e2e: ## Run deterministic service creation e2e test
	go test -v ./tests/e2e/ -run TestServiceCreationDeterministic ${E2E_TEST_FLAGS}
